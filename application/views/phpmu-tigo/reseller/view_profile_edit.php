           ...
           Pastikan data-data dibawah ini sudah benar, agar tidak terjadi kesalahan saat transaksi.</p>";                
                  ...
                  echo "<table class='table table-hover table-condensed'>
                        <thead>
                          ...
                          <tr><td><b>Tanggal Lahir</b></td>  <td><input class='required datepicker form-control' type='text' name='e' value='$row[tanggal_lahir]' data-date-format='yyyy-mm-dd' placeholder='tahun-bulam-tanggal'></td></tr>
